...
public class ImplementationCommandAddForExecuteScript {
    private static int resultSet;

    public static synchronized void implementationAddForExecuteScript(Stack<Flat> flats, ArrayList<String> arrayList, ObjectOutputStream out) throws IOException {
        try {
            Flat flat = new Flat();
            flat.setId();
            ...
            flat.setUser(new User(arrayList.get(11),(null)));
