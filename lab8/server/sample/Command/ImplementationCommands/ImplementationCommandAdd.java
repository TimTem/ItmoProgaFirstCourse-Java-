...
public class ImplementationCommandAdd{
    ...
    public synchronized static void implementationAdd(Stack<Flat> flats, ArrayList<String> arrayList, ObjectOutputStream out)throws IOException {
